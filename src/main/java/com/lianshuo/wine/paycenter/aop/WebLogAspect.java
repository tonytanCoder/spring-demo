package com.lianshuo.wine.paycenter.aop;
...
public class WebLogAspect {
	...
	@Pointcut("execution(* com.lianshuo.wine.paycenter.controller..*.*(..))")
	public void webLog() {
	}
	...
	public void doAfterThrowing(ControllerWebLog controllerWebLog, Throwable throwable) {
		Map<String, Object> threadInfo = threadLocal.get();
		if (controllerWebLog.intoDb()) {
			insertError(controllerWebLog.name(), (String) threadInfo.getOrDefault(REQUEST_PARAMS, ""), throwable);
		}
		threadLocal.remove();
